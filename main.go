...
//line main.kuki:239
	cfg := loadConfig()
//line main.kuki:241
	v, err_45 := input.ReadLine(fmt.Sprintf("Open WebUI URL [%v]: ", cfg.WebUIURL))
//line main.kuki:241
	if err_45 != nil {
//line main.kuki:241
		v = ""
...
//line main.kuki:245
	var err_46 error
	v, err_46 = input.ReadLine(fmt.Sprintf("Open WebUI API Key [%v]: ", maskKey(cfg.WebUIAPIKey)))
//line main.kuki:245
	if err_46 != nil {
//line main.kuki:245
		v = ""
...
//line main.kuki:249
	var err_47 error
	v, err_47 = input.ReadLine(fmt.Sprintf("Model [%v]: ", cfg.Model))
//line main.kuki:249
	if err_47 != nil {
//line main.kuki:249
		v = ""
...
//line main.kuki:253
	var err_48 error
	v, err_48 = input.ReadLine(fmt.Sprintf("terminal MCP URL [%v]: ", cfg.TerminalMCPURL))
//line main.kuki:253
	if err_48 != nil {
//line main.kuki:253
		v = ""
...
//line main.kuki:257
	var err_49 error
	v, err_49 = input.ReadLine(fmt.Sprintf("terminal MCP API Key [%v]: ", maskKey(cfg.TerminalMCPAPIKey)))
//line main.kuki:257
	if err_49 != nil {
//line main.kuki:257
		v = ""
...
//line main.kuki:261
	var err_50 error
	v, err_50 = input.ReadLine(fmt.Sprintf("Sandbox directory [%v]: ", cfg.SandboxDir))
//line main.kuki:261
	if err_50 != nil {
//line main.kuki:261
		v = ""
...
//line main.kuki:280
			var err_52 error
			prompt, err_52 = input.ReadLine(color.Bold(color.Cyan("you> ")))
//line main.kuki:280
			if err_52 != nil {
//line main.kuki:280
				break
...
//line main.kuki:301
		result, err_53 := runAgent(ctx, a, prompt, history)
//line main.kuki:301
		if err_53 != nil {
//line main.kuki:301
			//line main.kuki:302
			fmt.Println(color.BrightRed(fmt.Sprintf("error: %v", err_53)))
			//line main.kuki:303
			fmt.Println("")
			//line main.kuki:304
			prompt = ""
...
//line main.kuki:326
		data, err_54 := io.ReadAll(os.Stdin)
//line main.kuki:326
		if err_54 != nil {
//line main.kuki:326
			//line main.kuki:327
